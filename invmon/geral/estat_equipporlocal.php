...
print "<TR><TD class='line'><b>" . TRANS('COL_LOCAL') . "</TD><TD class='line'><b>" . TRANS('MNL_CAD_EQUIP') . "</TD><TD class='line'><b>" . TRANS('COL_QTD') . "</TD><TD class='line'><b>" . TRANS('COL_PORCENTEGE') . "</TD></tr>";
$i = 0;
$j = 2;
