...
print "<TR><td class='line'><b>" . TRANS("equip") . "</TD><td class='line'><b>" . TRANS("qtd") . "</TD><td class='line'><b>" . TRANS("perc") . "</TD></tr>";
$i = 0;
$j = 2;
...
while ($row = mysql_fetch_array($resultado)) {
    ...
    print "<td class='line'><a href='mostra_consulta_comp.php?comp_tipo_equip=" . $row['tipo'] . "' title='" . TRANS('hint_geral', '', 0) . "'>" . $row['Equipamento'] . "</a></TD>";
