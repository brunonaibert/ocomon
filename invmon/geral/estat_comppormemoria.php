...
print "<p align='center'>" . TRANS('OCO_FIELD_UNIT') . ": " . $msgInst . "</p><br/>";
...
print "<TR><TD class='line'><b>" . TRANS('MNL_CAD_EQUIP') . "</b></TD><TD class='line'><b>" . TRANS('MNL_MEMO') . "</b></TD><TD class='line'><b>" . TRANS('COL_QTD') . "</b></TD><TD class='line'><b>" . TRANS('COL_PORCENTEGE') . "</b></TD></tr>";
$i = 0;
$j = 2;
...
while ($row = mysql_fetch_array($resultado)) {
    ...
    print "<TD class='line'><a href='mostra_consulta_comp.php?comp_tipo_equip=" . $row['tipo'] . "&comp_memo=" . $row['tipo_memo'] . "&ordena=local,etiqueta' title='" . TRANS('HNT_LIST_EQUIP_CAD_QTD_MEMO') . "'>" . $row['memoria'] . " MB</a></TD>";
