...
"<TD><b>" . TRANS('COL_PORCENTEGE') . "</TD></tr>";
$i = 1;
$j = 2;
while ($row = mysql_fetch_array($resultado)) {
    ...
    print "<TD class='line'><a href='mostra_consulta_comp.php?comp_marca=" . $row['tipo_modelo'] . "&ordena=fab_nome,modelo,local,etiqueta' title='" . TRANS('HNT_SHOW_EQUIP_MODEL_CAD_SYSTEM') . "'>" . $row['fabricante'] . " " . $row['modelo'] . "</TD>";
