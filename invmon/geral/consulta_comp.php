...
<link href="../../includes/components/select2/dist/css/select2.min.css" rel="stylesheet" />
<script src="../../includes/components/select2/dist/js/select2.min.js"></script>
<script src="../../includes/components/select2/dist/js/i18n/pt-BR.js"></script>
...
?>
	<SCRIPT LANGUAGE="JAVASCRIPT">
		...
		$(window).on('load', function() {
			...
			$('.select2').addClass('js-example-basic-single');
...
print "<TD  bgcolor='" . TD_COLOR . "'><b>" . TRANS('OCO_FIELD_TAG') . "(s):</b></TD>";
print "<TD  bgcolor='" . BODY_COLOR . "'><INPUT type='text' class='text2' name='comp_inv'></TD>";

print "<TD  bgcolor='" . TD_COLOR . "'><b>" . TRANS('COL_SN') . ":</b></TD>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('COL_LOCALIZATION') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD  bgcolor='" . TD_COLOR . "'><b>" . TRANS('COL_SITUAC') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_MB') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_PROC') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_MEMO') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_VIDEO') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_SOM') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TR>";
print "<TD  bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_REDE') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_MODEM') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('MNL_DVD') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . BODY_COLOR . "'>";
print "<SELECT class='select2'  name='comp_tipo_imp'>";
print "<option value=-1>" . TRANS('SEL_ALL_CONS') . " </option>";
...
print "<TR>";
print "<TD   bgcolor='" . TD_COLOR . "'><b><a title='" . TRANS('MSG_POSSIBLE_SEL_UNIT_CTRL') . "'>" . TRANS('OCO_FIELD_UNIT') . ":</a></b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_CENTER_COST') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_DATE_PURCHASE') . ":</b></TD>";
...
print "<TD   bgcolor='" . TD_COLOR . "'><b>" . TRANS('FIELD_ASSISTENCE') . ":</b></TD>";
print "<TD   bgcolor='" . BODY_COLOR . "'>";
