...
echo "<br/><p class='center bold'>" . TRANS('OCO_FIELD_UNIT') . ": " . $msgInst . "</p>";
...
print "<TR><TD class='line'><b>" . TRANS('COL_SITUAC') . "</TD><TD class='line'><b>" . TRANS('COL_QTD') . "</TD><TD class='line'><b>" . TRANS('COL_PORCENTEGE') . "</TD></tr>";
$i = 0;
$j = 2;
$totalFull = 0;
...
print "<TR><TD class='line'><b></TD><TD class='line'><b>" . TRANS('TOTAL') . ": <font color='red'>" . $totalFull . "</font></TD><TD class='line'><b>" . TRANS('TXT_100') . "</b></TD></tr>";
print "</TABLE>";
