...
print "<TR><TD class='line'><b>" . TRANS('OCO_FIELD_UNIT') . "</TD><TD class='line'><b>" . TRANS('COL_QTD') . "</TD><TD class='line'><b>" . TRANS('COL_PORCENTEGE') . "</TD></tr>";
...
print "<TR><TD class='line'><b></TD><TD class='line'><b>" . TRANS('TOTAL') . ": " . $total . "</TD><TD class='line'><b>" . TRANS('TXT_100') . "</b></TD></tr>";
print "</TABLE>";
print "</fieldset>";
