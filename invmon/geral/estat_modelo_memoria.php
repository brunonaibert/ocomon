...
print "<TR><TD class='line'><b>" . TRANS('MNL_CAD_EQUIP') . "</TD><TD class='line'><b>" . TRANS('COL_MODEL') . "</TD><TD class='line'><b>" . TRANS('MNL_MEMO') . "</TD><TD class='line'><b>" . TRANS('COL_QTD') . "</TD><TD class='line'><b>" . TRANS('TTL_PORCENTEGE_FOR_MEMORY') . "</TD></tr>";
...
print "<TD class='line'><b>" . TRANS('TXT_100') . "</b></TD></tr>";
print "</TABLE>";
print "</fieldset>";
