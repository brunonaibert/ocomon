...
print "<b>" . TRANS('OCO_FIELD_UNIT') . ":</b>";
...
print "<br/><p class='bold center'>" . TRANS('OCO_FIELD_UNIT') . ": " . $msgInst . "</p><br/>";
...
print "<TR><TD class='line'><b>" . TRANS('MNL_CAD_EQUIP') . "</TD><TD class='line'><b>" . TRANS('COL_SITUAC') . "</TD><TD class='line'><b>" . TRANS('COL_QTD') . "</TD><TD class='line'><b>" . TRANS('COL_PORCENTEGE_FOR_TYPE') . "</TD></tr>";
...
print "<TR><TD class='line'><b></TD><TD class='line'><b></TD><TD class='line'><b>" . TRANS('TOTAL') . ": " . $total . "</TD><TD class='line'><b>" . TRANS('TXT_100') . "</b></TD></tr>";
print "</TABLE>";
print "</fieldset>";
