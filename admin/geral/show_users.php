...
echo "<table id='users-grid' class='display' style='width:100%'>";
    echo "<thead>";
        ...
        "<td class='line'>" . TRANS('OPT_LOGIN_NAME') . "</TD><td class='line'>" . TRANS('OCO_FIELD_AREA') . "</TD>" .
        "<td class='line'>" . TRANS('OCO_FIELD_AREA_ADMIN') . "</TD>" .
        "<td class='line'>" . TRANS('OCO_FIELD_SUBSCRIBE_DATE') . "</TD><td class='line'>" . TRANS('OCO_FIELD_HIRE_DATE') . "</TD>" .
        "<td class='line'>" . TRANS('OCO_FIELD_EMAIL') . "</TD><td class='line'>" . TRANS('OCO_FIELD_PHONE') . "</TD>" .
        "<td class='line'>" . TRANS('OCO_FIELD_LEVEL') . "</TD><td class='line'>" . TRANS('OCO_FIELD_ALTER') . "</TD>" .
        "<td class='line'>" . TRANS('OCO_FIELD_EXCLUDE') . "</TD></TR>";
        echo "</thead>";
