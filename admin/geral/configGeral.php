  ...
  */session_start();
	...
	if ((empty($_GET['action'])) and empty($_POST['submit'])){
		...
		else
		{
				...
				print "<td>". str_replace('.php', '', $row['conf_language']) ."</td>";
				print "</tr>";
				print "<tr><td colspan='2'>&nbsp;</td></tr>";
				...
				$NMSO = (strpos($row['conf_upld_file_types'],'%NMSO%'))?" checked":"";
				...
				print "<tr><td>".TRANS('OPT_UPLOAD_TYPE_NMSO')."</td><td><input type='checkbox' name='upld_nmso' disabled ".$NMSO."></td></tr>";
	...
	if ((isset($_GET['action']) && ($_GET['action']=="alter")) && empty($_POST['submit'])){
		...
		print "<tr><td>".TRANS('OPT_UPLOAD_TYPE_NMSO')."</td><td><input type='checkbox' name='upld_nmso' value='NMSO' ".$NMSO."></td></tr>";
	...
	if ($_POST['submit'] = TRANS('BT_ALTER')){
		...
		$FILE_TYPES.=isset($_POST['upld_nmso'])?$_POST['upld_nmso']."%":"";
