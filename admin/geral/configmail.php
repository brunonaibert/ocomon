  ...
  */session_start();
	...
	if ((empty($_GET['action'])) and empty($_POST['submit'])){
        ...
        else
        {
			...
			print "<tr><td>".TRANS('OPT_SMTP_PORT')."</td><td>".$row['mail_port']."</td></tr>";
			print "<tr><td>".TRANS('OPT_SMTP_SECURE')."</td><td>".$row['mail_secure']."</td></tr>";
	...
	if ( ((isset($_GET['action']) &&$_GET['action']=="alter")) && empty($_POST['submit'])){
		...
		print "<tr><td>".TRANS('OPT_SMTP_PORT')."</td><td>";
		print "<input type='text' class='text' name='port' value='".$row['mail_port']."'>";
		print "</td></tr>";

		print "<tr><td>".TRANS('OPT_SMTP_SECURE')."</td><td>";
		print "<input type='text' class='text' name='secure' value='".$row['mail_secure']."'>";
		print "</td></tr>";
	...
	if ($_POST['submit'] = TRANS('BT_ALTER')){
		...
		$qry = "UPDATE mailconfig SET ".
				...
				"mail_port= ".$_POST['port'].", mail_secure = '".noHtml($_POST['secure'])."', ".
