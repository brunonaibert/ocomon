...
(1, 'ocomon', NULL, 'localhost', 'ocomon', 'ocomon', 'CCUSTO', 'codigo', 'descricao', 'codccusto', 'http://localhost/ocomon_2.0/', -1, '../../includes/logs/', '../../includes/logos', '../../includes/icons/', '../../includes/icons/solucoes2.png', '../../includes/help/', 'pt_BR.php', 'SYSTEM', 307200, 800, 600, '%%mural%', 50, 'Categoria 1', 'Categoria 2', 'Categoria 3', 0, '%%IMG%', '%d/%m/%Y %H:%M:%S', 30, 1, 1, 0, 1, 1, 1, 0, 5);
...
(1, 'Diversos', -1, 7, -1, -1, -1, 1, 'Solicitações diversas - Configure no painel de administração em Admin::Ocorrências::Problemas');
...
(2, 'USUÁRIOS', 1, 'default@yourdomain.com', 0, NULL);
