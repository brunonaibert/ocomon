...
if (!isset($_POST['ok'])) {
    ...
    print "	<BR><BR>";
    print "	<B><h2 align='center'>::: " . TRANS('TLT_REPORT_CALL_FOR_EQUIP') . " :::</h2></B><BR><BR>";
            ...
            } else //if($linhas==0)
            {
                ...
                switch ($_POST['saida']) {
                    case -1:
                        ...
                        print "<tr class='header'><td class='line' colspan='5' align='center'><b>" . TRANS('TLT_REP_TOT_CALL_LABEL') . "</b><br>" . TRANS('FIELD_PERIOD_2') . ": " . $d_ini . " a " . $d_fim . "</td>";
                        print "<tr><td class='line' width='255'><B>   " . TRANS('COL_AMOUNT') . "</td>" .
                        "<td class='line' ><B>" . TRANS('FIELD_INSTITUTION') . "</td>" .
                        "<td class='line' ><B>" . TRANS('FIELD_TAG') . ";</td>" .
                        "<td class='line' ><B>" . TRANS('FIELD_LOCALIZATION') . "</td>" .
                        "<td class='line' ><B>" . TRANS('FIELD_AREA_2') . "</td>" .
                            "</tr>";
                        $conta = 0;
                        while ($row = mysql_fetch_array($resultado)) {
                            $conta += $row['total'];
                        ...
                        print "<tr><td class='line' align='center'><b>" . TRANS('FIELD_TOTAL_CALL') . ":</b></TD><td class='line' colspan='4' align='center'><b>" . $conta . "</b></td></tr>";
                        print "</table>";
