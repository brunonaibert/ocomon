...
// 	}
	...
	if (!isset($_POST['submit'])) {
		...
		print "<td><input type='submit' name='submit' class='button' value='".TRANS('BT_LOAD','',0)."'></td>".
				"<td><input type='button' name='cancelar' class='button' value='".TRANS('BT_CANCEL')."' onClick=\"javascript:history.back();\"></td>";
		print "</tr>";
