<?php 
  ...
  */
	...
	if (!isset($_POST['submit'])) {
		...
		print "<tr>";
		print "<td class='line' align='right'>Login</td><td class='line'><input type='text' class='text' name='login' id='idLogin' autocomplete='off'></td>";
		print "</tr>";
		print "<tr>";
		print "<td class='line' align='right'>Nome Completo</td><td class='line'><input type='text' class='text' name='nome' id='idNome'></td>";
		print "</tr>";
		print "<tr>";
		print "<td class='line' align='right'>E-mail</td><td class='line'><input type='text' class='text' name='email' id='idEmail'></td>";
		print "</tr>";
		print "<tr>";
		print "<td class='line' align='right'>Senha</td><td class='line'><input type='password' class='text' name='senha' id='idSenha'></td>";
		print "</tr>";
		print "<tr>";
		print "<td class='line' align='right'>Repita a senha</td><td class='line'><input type='password' class='text' name='senha2' id='idSenha2'></td>";
		print "</tr>";



		// print "<tr><td class='line' align='right'><input type='submit' class='button' name='submit' value='Cadastrar'></td>";
		print "<tr><td>&nbsp;</td>";

		print "<td class='line'><input type='submit' class='button' name='submit' value='Cadastrar'>&nbsp;&nbsp;&nbsp;<input type='button' class='button'  name='fecha' value='Cancelar' onClick=\"javascript:window.close()\"></td></tr>";
	...
	if (isset($_POST['submit'])) {
        ...
        //TESTA A EXPRESSAO: IMPORTANTE CASO O JAVASCRIPT NAO ESTEJA HABILITADO!
		if (!valida(TRANS('MNS_USUARIO'), $_POST['login'], 'USUARIO', 1, $ERRO)) {
			print "<script>mensagem('".$ERRO."'); history.back();</script>";
			print "NOME DE USUÁRIO NAO ACEITO!";
			exit;
		}		
