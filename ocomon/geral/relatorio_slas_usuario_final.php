...
if (isset($_GET['ini']) && isset($_GET['end']) && $_GET['ini'] <= $_GET['end']) {
    ...
    if ($linhas == 0) {
        ...
        $background = '#C7D0D9';
		print "<br/><h2 align='center'>RELATÓRIO DE SLAS: INDICADORES DE RESPOSTA e INDICADORES DE SOLUÇÃO</h2>";
		print "<h3 align='center'>" . $criterio . "</h3><br/>";
        print "<table style='border: 1px solid black;'>";

        print "<tr class='header'><td class='line'><B>NUMERO</td>
		...
		print "<br/><br/>";
		//print "<div class='centraliza'>";
        print "<table width='50%' align='center' style='margin:auto;' cellspacing='0'>";
       
        print "  <tr class='header'><td colspan=4 align=center><b>Período: " . $_GET['ini'] . " a " . $_GET['end'] . "</b></td></tr>";
        print "  <tr class='header'><td colspan=4 align=center><b>Total de horas válidas no período: " . $hValido . "</b></td></tr>";
        print "  <tr class='header'><td colspan='4' align='center'><b>Total de chamados fechados no período: $linhas.</b></td></tr>";
		...
		$linkNumerosRgreen = (!empty($numerosRgreen) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosRgreen . "')\">" : '');
		
		$linkNumerosRyellow = (!empty($numerosRyellow) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosRyellow . "')\">" : '');

		$linkNumerosRred = (!empty($numerosRred) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosRred . "')\">" : '');

		$linkNumerosYellow = (!empty($numerosYellow) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosYellow . "')\">" : '');
		
		$linkNumerosGreen = (!empty($numerosGreen) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosGreen . "')\">" : '');

		$linkNumerosRed = (!empty($numerosRed) ? "<a onClick= \"javascript: popup_alerta('mostra_chamados.php?popup=true&numero=" . $numerosRed . "')\">" : '');

        print "<tr class='header'><td colspan='4' align='center' class='line'><b>Tempo de Resposta X SLA definidos</b></td></tr>";
        print "<tr><td class='line'><b>Resposta dentro do SLA:</td><td class='line'><font color='blue'>{$linkNumerosRgreen}" . $c_slaR_blue . "</a></font> chamados</b></td><td class='line'>" . $perc_blueR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla1.png'></td></tr>";
        print "<tr><td class='line'><b>Resposta até " . $percLimit . "% acima do SLA:</td><td class='line'><font color='blue'>{$linkNumerosRyellow}" . $c_slaR_yellow . "</a></font> chamados</b></td><td class='line'>" . $perc_yellowR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla2.png'></td></tr>";
        print "<tr><td class='line'><b>Resposta acima de " . $percLimit . "% do SLA:</td><td class='line'><font color='blue'>{$linkNumerosRred}" . $c_slaR_red . "</a></font> chamados</b></td><td class='line'>" . $perc_redR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla3.png'></td></tr>";
        ...
        print "<tr class='header'><td class='line' colspan='4' align='center'><b>Tempo de Solução X SLA definidos</b></td></tr>";
        ...
        print "<tr class='header'><td class='line' colspan='4' align='center'><b>Tempo de Solução a partir da 1.ª resposta</b></td></tr>";
        ...
        print "<tr class='header'><td class='line' colspan='4' align='center'><b>Tempo de Solução recalculado</b></td></tr>";
        print "<tr><td class='line'><b>Solução dentro do SLA:</td><td class='line'><font color='blue'>{$linkNumerosGreen}" . $c_slaSR_blue . "</a></font> chamados</b></td><td class='line'>" . $perc_blueSR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla1.png'></td></tr>";
        print "<tr><td class='line'><b>Solução até " . $percLimit . "% acima do SLA:</b></td><td class='line'><font color='blue'>{$linkNumerosYellow}" . $c_slaSR_yellow . "</a></font> chamados</td><td class='line'>" . $perc_yellowSR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla2.png'></td></tr>";
        print "<tr><td class='line'><b>Solução acima de " . $percLimit . "% do SLA:</b></td><td class='line'><font color='blue'>{$linkNumerosRed}" . $c_slaSR_red . "</a></font> chamados</td><td class='line'>" . $perc_redSR . "%</td><td class='line'><img height='14' width='14' src='../../includes/imgs/sla3.png'></td></tr>";
        ...
        print "<tr class='header'><td class='line'>STATUS</td><td  class='line' colspan='2'>TEMPO</td><td class='line'>PERCENTUAL</td></tr>";
        ...
        print "<tr class='header'><td class='line'>DEPENDÊNCIA</td><td  class='line' colspan='2'>TEMPO</td><td class='line'>PERCENTUAL</td></tr>";
        while ($row_vinc = mysql_fetch_array($exec_vinc)) {
            print "<tr><td class='line'>" . $row_vinc['dependencia'] . "</td><td colspan='2'>" . $row_vinc['tempo'] . "</td><td class='line'>" . round($row_vinc['porcento'],2) . "%</td></tr>";

        }
        print "  <tr class='header'><td colspan=4>&nbsp;</td></tr>";
