<?php 
  ...
  */session_start();
    ...
    print "</head>";
		...
		print "	<BR><BR>";
		print "	<B><h2 align='center'>:::".TRANS('TLT_CALL_CLOSE_SECTOR').":::</h2></B><BR><BR>";
				...
				if (($linhas==0) ) {
					...
					switch($_POST['saida'])
					{
						case -1:
                            			...
                            			echo "<br><br>";
						$background = '#CDE5FF';
						print "<h2 align='center'>".TRANS('TLT_CALL_CLOSE_SECTOR')."</h2>";
						print "<p align='center'><b>".TRANS('TLT_PERIOD_FROM')." ".$_POST['d_ini']." a ".$_POST['d_fim']."</b></p><br/>";

                        print "<table class='centro' cellspacing='0' style='border: 1px solid black;' align='center' >";

						print "<tr class='header'><td class='line'><B>".TRANS('COL_AMOUNT')."</td>
							   <td class='line' ><B>".TRANS('COL_SECTOR_FACTORY')."</td>
						...
						print "<tr><td class='line'><b>".$total."</b></td><td class='line'  colspan='2'><b>".TRANS('COL_OVERALL')."</b></td></tr>";
