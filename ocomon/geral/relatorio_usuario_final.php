...
if (!isset($_POST['ok'])) {
    ...
    print "<body>";
    print "	<BR><BR>";
    print "	<B><h2 class='center'>::: " . TRANS('TTL_CALL_OPEN_USER_FINISH_2') . " :::</h2></B><BR><BR>";
    print "		<FORM action='" . $_SERVER['PHP_SELF'] . "' method='post' name='form1' onSubmit=\"return valida();\">";
    print "		<TABLE width='50%' border='0' class='center' cellspacing='2' >";
    ...
    print "					<td class='line'><INPUT name='d_ini' class='data' id='idD_ini' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line' align='right'>" . TRANS('OCO_FIELD_DATE_FINISH') . ":</td>";
    print "					<td class='line'><INPUT name='d_fim' class='data' id='idD_fim' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";

    print "				<tr>";
    print "					<td class='line' align='right'>" . TRANS('FIELD_CURRENT_MONTH') . "</td>";
    ...
    if (((!isset($_POST['d_ini'])) and (!isset($_POST['d_fim']))) and !isset($_POST['mesAtual'])) {
        ...
        if ($d_ini_completa <= $d_fim_completa) {
            ...
            if ($linhas == 0) {
				...
				print "<h2 align='center'><b>" . TRANS('TTL_CALL_OPEN_USER_AREA') . ": " . $nomeArea . " </b></h2><br/>";
				print "<b><p align='center'>" . TRANS('TTL_PERIOD_FROM') . " " . $d_ini . " a " . $d_fim . "</p></br><br/>";
                print "<table width='50%' class='centro' cellspacing='0' style='border: 1px solid black;' align='center'>";

                print "<tr class='header'><td class='line'><B>" . TRANS('COL_AMOUNT') . "</td>" .
                "<td class='line' ><B>" . TRANS('FIELD_USER') . "</td>" .
				...
				print "</table>";
				print "<br/><p align='center'>" . TRANS('TXT_IT_VERIFIES') . " <a onClick=\"javascript:popup_alerta('relatorio_slas_usuario_final.php?ini=" . $d_ini_completa . "&end=" . $d_fim_completa . "&area=" . $_POST['area'] . "')\"><font color='blue'>" . TRANS('TLT_REPORT_SLAS') . "</font></a> " . TRANS('TXT_OLD') . ".</p>";
            } //if($linhas==0)
        } else {
