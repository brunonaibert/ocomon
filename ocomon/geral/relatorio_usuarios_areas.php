...
if (!isset($_POST['ok'])) {
    ...
    print "</head>";
    print "	<BR><BR>";
    print "	<B><h2 align='center'>::: " . TRANS('TTL_USERS_AREA_ATTEND') . " :::</h2></B><BR><BR>";
    print "		<FORM action='" . $_SERVER['PHP_SELF'] . "' method='post' name='form1'>";
    print "		<TABLE class='centro' border='0' width='40%' align='center' cellspacing='1' bgcolor=" . BODY_COLOR . " >";
    print "				<tr>";
    print "					<td width='30%' align='right' >" . TRANS('OCO_FIELD_AREA') . ":</td>";
    ...
    print "					<td  align='right' >" . TRANS('OCO_FIELD_DATE_BEGIN') . ":</td>";
    print "					<td class='line'><INPUT name='d_ini' id='d_ini' class='data' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    print "					<td  align='right' >" . TRANS('OCO_FIELD_DATE_FINISH') . ":</td>";
    print "					<td class='line'><INPUT name='d_fim' id='d_ini' class='data' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";

    print "				<tr>";
    print "					<td  align='right' >" . TRANS('FIELD_REPORT_TYPE') . ":</td>";
    ...
    print "				</tr>";
    print "		</TABLE><br>";
    print "		<TABLE align='center' class='centro'>";
    print "			<tr>";
    print "	            <td class='line'>";
            ...
            } else //if($linhas==0)
            {
                ...
                switch ($_POST['saida']) {
                    case -1:
                        ...
                        echo "<br><br>";
                        $background = '#CDE5FF';
						print "<h2 align='center'>" . TRANS('TTL_USERS_AREA_ATTEND') . "</h2><br/>";
						print "<p align='center'><b>" . TRANS('TTL_PERIOD_FROM') . " " . $d_ini . " a " . $d_fim . "</b></p><br/>";
                        ...
                        "<td class='line'><B>" . TRANS('COL_SECTOR') . "</td>" .
