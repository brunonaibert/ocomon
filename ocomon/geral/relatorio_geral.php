...
if (!isset($_POST['ok'])) { //&& $_POST['ok'] != 'Pesquisar')
    ...
    print "<body>";
    print "	<BR><BR>";
    print "	<B><h1 align='center'>:::" . TRANS('REP_GENERAL') . ":::</h1></B><BR><BR>";
    print "		<FORM action='" . $_SERVER['PHP_SELF'] . "' method='post' name='form1' onSubmit=\"return valida()\" >"; //onSubmit=\"return valida()\"
    print "		<TABLE border='0' align='center' style='margin:auto;' cellspacing='2'  bgcolor=" . BODY_COLOR . " >";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_FIELD_AREA') . ":</td>";
    ...
    print "				<tr>";
    print "						<td class='line'>" . TRANS('OCO_FIELD_UNIT') . ":</td>";
    ...
    print "					</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_LOCAL') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_FIELD_OPERATOR') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_FIELD_DATE_BEGIN') . ":</td>";
    //print "                    <td class='line'><INPUT  type='text' class='data' name='d_ini'>  (Exemplo: 20/01/2004)</td>";
    print "					<td class='line'><INPUT class='text' type='text' name='d_ini' id='idD_ini' value='01/" . date("m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_FIELD_DATE_FINISH') . ":</td>";
    //print "                    <td class='line'><INPUT type='text'  class='data' name='d_fim'>  (Exemplo: 27/01/2004)</td>";
    print "					<td class='line'><INPUT class='text' type='text' name='d_fim' id='idD_fim' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_DATE_THIS') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('MNL_STATUS') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('OCO_ORDER_BY') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line'>" . TRANS('FIELD_REPORT_TYPE') . ":</td>";
    ...
    print "				</tr>";
    print "				<tr>
							<td class='line' colspan='2'><input type='checkbox' name='novaJanela' title='" . TRANS('HNT_NEW_WINDOW') . ".'>&nbsp;" . TRANS('OPT_NEW_WINDOW') . "
							</td>
						</tr>";
...
//         } else { //(($d_ini < $d_fim) or ($d_ini == $d_fim))
    ...
    switch ($_POST['saida']) {
        case -1:
            $cor1 = TD_COLOR;
            print "<BR><BR><h1 align='center'>::: " . TRANS('TLT_REPORT_OCCOR') . " :::</h1><BR><BR>";
            print "<p align='center'>" . $frase . "</p>";
            print "<table border='0' cellpadding='3' cellspacing='0' align='center' width='100%' style='margin:auto;'>";
            print "<tr class='header'>";
            print "<td class='line'><b>" . TRANS('OCO_FIELD_NUMBER') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_PROB') . "</b></td>";
            print "<td class='line'><b>" . TRANS('COL_SCRIPT_SOLUTION') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_AREA') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_FIELD_UNIT') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_LOCAL') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_FIELD_OPERATOR') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_FIELD_DATE_BEGIN') . "</b></td>";
            print "<td class='line'><b>" . TRANS('OCO_FIELD_DATE_FINISH') . "</b></td>";
            print "</tr>";
            $i = 0;
            $j = 2;
            while ($row = mysql_fetch_array($resultado)) {
                ...
                $j++;
                print "<tr " . (isPar($j) ? "class='lin_par'" : "class='lin_impar'") . ">";
                print "<td class='line'><a onClick=\"javascript:popup_alerta('mostra_consulta.php?popup=true&numero=" . $row['numero'] . "')\">" . $row['numero'] . "</a></td>"; //nome q eu dei no select name=
                print "<td class='line'>" . $row['problema'] . "</td>";
                print "<td class='line'>" . $row['script_desc'] . "</td>";
                print "<td class='line'>" . $row['area'] . "</td>";
                if ($row['unidade_cod'] == '') {
                    print "<td class='line'> - </td>";
                } else {
                    print "<td class='line'> " . $row['unidade'] . "</td>";
                }
                print "<td class='line'> " . $row['setor'] . "</td>";
                print "<td class='line'> " . $row['nome'] . "</td>";
                print "<td class='line'> " . converte_datacomhora($row['data_abertura']) . "</td>";

                if ($row['data_fechamento'] == null) {
                    print "<td class='line'>  -  </td>";
                } else {
                    print "<td class='line'> " . converte_datacomhora($row['data_fechamento']) . "</td>";
                }
                print "</tr>";
            } // while
            print "</table>";
        ...
        case 1:
            ...
            gera_relatorio(1, $query_ini, $campos, $cabs, "../../includes/logos/MAIN_LOGO.png", "OCOMON", $hoje, "Relatório de Ocorrências");
            break;
    } // switch
} //if $ok==Pesquisar
