...
if (!isset($_POST['ok']) && !isset($_GET['action'])) {
    ...
    print "	<BR><BR>";
    print "	<B><h2 align='center'>::: " . TRANS('TTL_BOARD_CALL_AREA_ATTEND') . " :::</h2></B><BR><BR>";
    print "		<FORM action='" . $_SERVER['PHP_SELF'] . "' method='post' name='form1' onSubmit='return valida()'>";
    print "		<TABLE border='0' align='center' cellspacing='2' style='margin: auto;'  bgcolor=" . BODY_COLOR . ">";
    print "				<tr>";
    ...
    print "					<td class='line'><INPUT name='d_ini' class='data' id='idD_ini' value='01/" . date("m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
...
if (isset($_POST['ok'])) {
    ...
    if ((!isset($_POST['d_ini'])) || (!isset($_POST['d_fim']))) {
        ...
        if ($d_ini_completa <= $d_fim_completa) {
			...
			print "<br/><h2 align='center'>" . TRANS('TTL_GENERAL_BOARD_CALL_ATTEND') . "</h2>";
            ...
            print "<tr class='header'><td class='line'><b>" . TRANS('COL_ATTEN_AREA') . "</b></TD><td colspan='3' align='center'><b>" . TRANS('COL_CALL') . "</b></td></tr>";
