...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_POST['operador']) and $_POST['operador'] != -1) {
        if (isset($_POST['opAbertura'])) {
            $query .= " and o.aberto_por = " . $_POST['operador'] . " ";
        } else {
    ...
    if (isset($_POST['saida']) && $_POST['saida'] == 1) {
        ...
        while ($row = mysql_fetch_array($resultado)) {
            ...
            if (($row['status_cod'] == 1)) {$calcula = true;} else {
                $calcula = false;
            }
            ...
            if ($_POST['tipo_data'] == "abertura") {
                print "<TD " . $valign . ">" . formatDate($row['data_abertura']) . "</TD>";
            } else {
                print "<TD " . $valign . ">" . formatDate($row['data_fechamento']) . "</TD>";
            }
