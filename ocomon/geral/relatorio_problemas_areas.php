...
if (!isset($_POST['ok'])) { //&& $_POST['ok'] != 'Pesquisar')
    ...
    print "	<BR><BR>";
    print "	<B><h2 align='center'>:::" . TRANS('TLT_PROBLEMS_AREAS') . ":::</h2></B><BR><BR>";
    ...
    //print "                    <td class='line'><INPUT name='d_ini' class='text'><a href=\"javascript:cal1.popup();\"><img src='../../includes/javascript/img/cal.gif' width='16' height='16' border='0' alt='Selecione a data'></a></td>";
    print "					<td class='line'><INPUT type='text' name='d_ini' class='text' id='idD_ini' value='01/" . date("m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    ...
    print "					<td class='line'><INPUT type='text' name='d_fim' class='text' id='idD_fim' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";

    print "				<tr>";
    print "					<td class='line' align='right'>" . TRANS('FIELD_REPORT_TYPE') . ":</td>";
    print "					<td class='line'><select name='saida' class='select'>";
            ...
            if ($linhas == 0) {
                ...
                switch ($_POST['saida']) {
                    case -1:
                        ...
                        echo "<br><br>";
                        $background = '#CDE5FF';
						print "<h2 align='center'>" . TRANS('TLT_CALL_FINISH_PROB_AREA') . "</h2>";
						print "<p align='center'><b>PERÍODO DE " . $_POST['d_ini'] . " a " . $_POST['d_fim'] . "</b></p><br/>";
