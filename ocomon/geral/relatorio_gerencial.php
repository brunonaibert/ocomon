...
if (!isset($_POST['ok'])) {
    ...
    print "	<BR><BR>";
    print "	<B><h2 align='center'>::: Relatório gerencial por período :::</h2></B><BR><BR>";
    print "		<FORM action='" . $_SERVER['PHP_SELF'] . "' method='post' name='form1' onSubmit='return valida()'>";
    print "		<TABLE border='0' align='center' bgcolor=" . BODY_COLOR . " cellspacing='1' style='margin:auto;'";
    print "				<tr>";
    print "					<td class='line' align='right'>Área Responsável:</td>";
    ...
    print "					<td class='line' align='right'>Data Inicial:</td>";
    ...
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line' align='right'>Data Final:</td>";
    ...
    print "				<tr>";
    print "					<td class='line' align='right'>Tipo de relatório:</td>";
...
else //if $ok==Pesquisar
{
    ...
    //<GAMBIARRA>
    $SW = 9;
    $HW = 11; //CÓDIGOS DAS ÁREAS HELPDESK E CONSTAT (SOFTWARE E HARDWARE)//
    $SW_PREV = 107;
    $HW_PREV = 87; //CÓDIGOS DAS PREVENTIVAS DE SOFTWARE E HARDWARE//
    $SUCATA = 7;
    $TROCADO_FURTADO = '4,5';
    //</GAMBIARRA>
    ...
    if ((!isset($_POST['d_ini'])) || (!isset($_POST['d_fim']))) {
        ...
        if ($d_ini_completa <= $d_fim_completa) {
            ...
            print "<br/><p align='center'><b>PERÍODO DE " . $d_ini . " a " . $d_fim . "</b></p>";
            print "<br/><p align='center'>Horas válidas no período: " . $hValido . " horas</p>";
            ...
            print "<br/><b><p align='center'>QUADRO GERAL DE CHAMADOS DO PERÍODO</p></b><br/>";
            print "<table cellspacing='0' border='1' style='margin:auto;'>";
            print "<tr class='header'><td class='line'><b>ÁREA DE ATENDIMENTO</b></TD><td class='line' colspan='3' align='center'><b>CHAMADOS</b></td></tr>";
            ...
            print "<br/><p align='center' style='font-weight:bold'>QUADRO DE CHAMADOS PENDENTES NO PERÍODO</p><br/>";
            print "<blockquote>";
            print "<table cellspacing='0' border='1' align='center' style='margin:auto;'>";
            print "<tr class='header'><td class='line'>&nbsp;</TD><td colspan='2' class='line' align='center'><b>INÍCIO DO PERÍODO</b></td><td class='line' colspan='2' align='center'><b>FINAL DO PERÍODO</b></td></tr>";
            ...
            #####NOVA TABELA
            print "<br/><p style='font-weight: bold' align='center'>SETORES QUE MAIS ABRIRARM CHAMADOS</p><br/>";
            print "<blockquote>";
            print "<table cellspacing='0' border='1' align='center' style='margin:auto'>";
            print "<tr class='header'><td class='line'><b>ÁREA</b></td><td class='line'><b>SETOR</b></td><td class='line'><b>QUANTIDADE</b></td><td class='line'><b>MÉDIA POR EQUIPAMENTO</b></td></tr>";
            ...
            while ($rowD = mysql_fetch_array($exec_qry_areasD)) {
                ...
                $t_rowD = mysql_num_rows($exec_qry_fe_sw_setor);
                //----------TABELA 2 -------------------//
            ...
            while ($rowF = mysql_fetch_array($exec_qry_areasF)) {
                ...
                $t_rowF = mysql_num_rows($exec_qry_us_sw);
            ...
            while ($rowH = mysql_fetch_array($exec_qry_areasH)) {
                ...
                $t_rowH = mysql_num_rows($exec_qry_ab_sw_reit);
            ...
            while ($rowJ = mysql_fetch_array($exec_qry_areasJ)) {
                ...
                $t_rowJ = mysql_num_rows($exec_qry_fe_sw_prob);
