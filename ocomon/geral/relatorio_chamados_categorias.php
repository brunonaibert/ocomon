...
if (!isset($_POST['ok']) && !isset($_GET['action'])) { //&& $_POST['ok'] != 'Pesquisar')
    ...
    print "	<BR><BR>";
    print "	<B><h2 align='center'>:::" . TRANS('TTL_REP_CALL_X_PROBCAT') . ":::</h2></B><BR><BR>";
    ...
    print "				<tr>";
    print "					<td class='line' align='right'>" . $row_config['conf_prob_tipo_1'] . ":</td>";
    ...
    print "				<tr>";
    print "					<td class='line' align='right'>" . $row_config['conf_prob_tipo_2'] . ":</td>";
    ...
    print "				<tr>";
    print "					<td class='line' align='right'>" . $row_config['conf_prob_tipo_3'] . ":</td>";
    ...
    print "					<td class='line'><INPUT name='d_ini' id='d_ini' class='data' value='01/" . date("m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
    print "				<tr>";
    print "					<td class='line' align='right'>" . TRANS('OCO_FIELD_DATE_FINISH') . ":</td>";
    print "					<td class='line'><INPUT name='d_fim' id='d_fim' class='data' value='" . date("d/m/Y") . "' autocomplete='off'></td>";
    print "				</tr>";
            ...
            if ($linhas == 0) {
                ...
                switch ($_POST['saida']) {
                    case -1:
                        ...
                        echo "<br><br>";
                        $background = '#CDE5FF';
						print "<h2 align='center'>" . TRANS('TTL_REP_CALL_CLOSED_X_PROBCAT') . "</h2>";
						print "<p align='center'><b>" . TRANS('TTL_PERIOD_FROM') . " " . $_POST['d_ini'] . " a " . $_POST['d_fim'] . "</b></p><br/>";
                        print "<table class='centro' cellspacing='0' border='1' align='center' >";

                        print "<tr><td class='line' colspan='5' align='center'>" . TRANS('FIELD_CRITE_EXIBIT') . ": " . $criterio . "</td></tr>";
                        
                        print "<tr class='header'><td class='line'><B>" . TRANS('COL_QTD') . "</td>" .
                        "<td class='line'><B>" . TRANS('COL_ATTEN_AREA') . "</td>" .
                            "<td class='line'><B>" . $row_config['conf_prob_tipo_1'] . "</td>" .
                            "<td class='line'><B>" . $row_config['conf_prob_tipo_2'] . "</td>" .
                            "<td class='line'><B>" . $row_config['conf_prob_tipo_3'] . "</td>" .
                            "</tr>";
                        $total = 0;
                        while ($row = mysql_fetch_array($resultado)) {
                        ...
                        print "<tr><td class='line' colspan='2' align='center'><b>" . TRANS('TOTAL') . "</b></td><td colspan='3' align='center'><b>" . $total . "</b></td></tr>";
