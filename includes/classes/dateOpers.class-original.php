...
## CRIAR VARIAVEL PARA DEFINICAO DO PADRAO DE DATA EX: PADRAO AMERICANO, PADRAO BRASILEIRO
...
class dateOpers {
	...
	function formatDate ($data){ //Retorna sa�da no formado AAAA-MM-DD HH:mm:SS
		...
		if (preg_match ("/([0-9]{1,2})[\/|-]([0-9]{1,2})[\/|-]([0-9]{4}) ([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2})/", preg_quote($data, '/'), $sep)) {
